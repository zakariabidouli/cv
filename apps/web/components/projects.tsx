        ...
        <div className="flex gap-3 border-t border-border/50 pt-4 mt-4">
          ...
          {project.github_url && (
            <a
              ...
              className="flex-1 px-4 py-2.5 rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2 text-sm group/link text-primary"
            >
